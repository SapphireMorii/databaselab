									...
									<ul>
										<c:if test="${bean.currentPage!=1}">
											<li class="disablepage_p">
												<a class="disablepage_a" href="${pageContext.request.contextPath}/findOrders?currentPage=${bean.currentPage-1}"></a>
											</li>
										</c:if>
										<c:if test="${bean.currentPage==1}">
										...
										<c:forEach begin="1" end="${bean.totalPage}" var="pageNum">
											...
											<c:if test="${pageNum!=bean.currentPage}">
												<li><a href="${pageContext.request.contextPath}/findOrders?currentPage=${pageNum}">${pageNum}</a>
												</li>
											</c:if>
										</c:forEach>

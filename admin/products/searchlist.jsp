									...
									<ul>
										<c:if test="${bean.currentPage!=1}">
											<li class="disablepage_p">
												<a class="disablepage_a" href="${pageContext.request.contextPath}/findProductByManyCondition?currentPage=${bean.currentPage-1}&&minprice=${minprice}&&maxprice=${maxprice}"></a>
											</li>
										</c:if>
										<c:if test="${bean.currentPage==1}">
										...
										<c:forEach begin="1" end="${bean.totalPage}" var="pageNum">
											...
											<c:if test="${pageNum!=bean.currentPage}">
												<li><a href="${pageContext.request.contextPath}/findProductByManyCondition?currentPage=${pageNum}&&minprice=${minprice}&&maxprice=${maxprice}">${pageNum}</a>
												</li>
											</c:if>
										</c:forEach>
